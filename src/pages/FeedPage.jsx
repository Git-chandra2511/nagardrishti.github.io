    ...
    <div className="page narrow-page">
      ...
      <div className="feed-grid">
        ...
        <aside className="panel trend-panel">
          ...
          <div className="trend"><span>Potholes</span><b>42%</b><i style={{ width: '82%' }} /></div>
          <div className="trend"><span>Garbage</span><b>27%</b><i style={{ width: '61%' }} /></div>
          <div className="trend"><span>Streetlights</span><b>18%</b><i style={{ width: '44%' }} /></div>
          <div className="trend"><span>Waterlogging</span><b>13%</b><i style={{ width: '31%' }} /></div>
